          ...
          <div>
            ...
            <div className="rounded-lg border border-gray-200 p-4 dark:border-gray-800">
              ...
              {data.customer.address && (
                <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">{data.customer.address}</p>
              )}
            </div>
          </div>

          <div>
            <h3 className="mb-3 text-sm font-semibold uppercase tracking-wide text-gray-500">Producten</h3>
