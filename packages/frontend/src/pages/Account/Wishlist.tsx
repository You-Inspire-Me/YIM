  ...
  if (isLoading) {
    return (
      <div className="mx-auto max-w-7xl px-4 py-12">
        <h1 className="text-3xl font-extrabold text-[#1E293B] mb-8">{t('account.wishlist')}</h1>
    ...
    <div className="mx-auto max-w-7xl px-4 py-12">
      ...
      {!wishlist || wishlist.length === 0 ? (
        <div className="text-center py-16">
          <Heart className="h-20 w-20 text-[#E2E8F0] mx-auto mb-6" />
          <h2 className="text-2xl font-extrabold text-[#1E293B] mb-3">Je hebt nog niets geliked</h2>
          <p className="text-[#64748B] mb-8 max-w-md mx-auto">
            Ga inspiratie opdoen! Like looks, producten en creators die je leuk vindt.
          </p>
          <Link
            to="/"
            className="inline-block rounded-full bg-[#0EA5E9] px-6 py-3 text-sm font-semibold text-white transition hover:bg-[#0284C7]"
          >
            Ontdek looks
          </Link>
        </div>
          ...
          {wishlist.map((item: any) => {
            ...
            return (
              <div
                ...
                className="group relative overflow-hidden rounded-2xl bg-white border border-[#E2E8F0] shadow-sm transition hover:shadow-lg"
              >
                <Link
                  to={
                    isLook
                ...
                >
                  ...
                  <div className="p-4">
                    <p className="font-semibold text-[#1E293B] truncate">{item.title || item.name}</p>
