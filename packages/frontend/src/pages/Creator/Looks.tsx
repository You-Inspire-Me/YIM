    ...
    <div className="space-y-6">
      ...
      {isLoading ? (
          ...
          {data.looks.map((look) => (
            ...
            >
              <div className="relative aspect-[4/5] overflow-hidden">
                ...
                />
                {!look.published && (
                  <div className="absolute left-2 top-2 rounded-full bg-gray-900/70 px-2 py-1 text-xs font-semibold text-white">
                    Concept
                  </div>
                )}
                <div className="absolute right-2 top-2 flex gap-2 opacity-0 transition-opacity group-hover:opacity-100">
                  <button
                    type="button"
                    onClick={() => togglePublishedMutation.mutate(look._id)}
                    className="rounded-full bg-white/90 p-2 shadow-sm transition hover:bg-white dark:bg-gray-800/90 dark:hover:bg-gray-800"
              ...
              <div className="p-4">
                ...
                <p className="mt-1 line-clamp-2 text-sm text-gray-500 dark:text-gray-400">{look.description}</p>
                ...
                <div className="mt-4 flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="rounded-lg border border-gray-200 px-3 py-1.5 text-sm font-medium transition hover:bg-gray-50 dark:border-gray-700 dark:hover:bg-gray-800"
                    >
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-12 text-center dark:border-gray-800 dark:bg-gray-900">
          <p className="text-gray-500 dark:text-gray-400">Je hebt nog geen looks aangemaakt.</p>
