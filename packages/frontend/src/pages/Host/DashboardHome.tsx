...
const DashboardHome = (): JSX.Element => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        {statCards.map((stat) => {
          ...
          return (
            <div
              key={stat.title}
              className="rounded-xl border border-border bg-white p-6 shadow-sm dark:border-border dark:bg-primary"
            >
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-muted dark:text-muted">{stat.title}</p>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-xl border border-border bg-white p-6 shadow-sm dark:border-border dark:bg-primary">
          ...
          {lowStockProducts.length === 0 ? (
            <p className="text-sm text-muted dark:text-muted">Geen producten met lage voorraad</p>
          ) : (
      ...
      <div className="rounded-xl border border-border bg-white shadow-sm dark:border-border dark:bg-primary">
