      ...
      {isLoading ? (
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {data.looks.map((look) => (
            <div
              key={look._id}
              className="group relative overflow-hidden rounded-xl border border-border bg-white shadow-sm transition hover:shadow-lg dark:border-border dark:bg-primary"
            >
